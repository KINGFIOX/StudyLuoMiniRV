...
/** rs1/rs2 info directly from ID, available in current cycle, needed by both hazard & forward module.
  */
...
class WB extends Module {
  ...
  io.reg.data := MuxLookup(
    io.in.ctl_wb.rfw_sel,
    0.U,
    Seq(
